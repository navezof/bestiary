...
export const Strength: CharacteristicDefinition = {
    name: "Strength",
    description: "A measure of a creature's physical power and ability to exert force."
};

export const Toughness: CharacteristicDefinition = {
    name: "Toughness",
    description: "A measure of a creature's resilience and ability to withstand damage."
};
...
export const Intelligence: CharacteristicDefinition = {
    name: "Intelligence",
    description: "A measure of a creature's cognitive abilities and problem-solving skills."
};
...
export const Fellowship: CharacteristicDefinition = {
    name: "Fellowship",
    description: "A measure of a creature's social skills and ability to interact with others."
};
