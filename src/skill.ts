...
export class Skill {
    ...
    public readonly linkedCharacteristic: string;

    private _characteristics: Characteristic;
    private _advances: number;
    private _specialization: string;

    constructor(creature: Creature, definition: SkillDefinition, baseAdvance?: number, specialization?: string) {
        this.name = definition.name;
        this.description = definition.description;
        this.linkedCharacteristic = definition.linkedCharacteristic;

        this._characteristics = creature.getCharacteristic(this.linkedCharacteristic)!;
